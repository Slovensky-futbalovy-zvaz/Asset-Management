...
### Kategória
Hierarchická klasifikácia majetku — napr. *IT > Notebooky > Pracovné notebooky*. Kategórie určujú, kto môže schvaľovať zápožičky a aké špecifické polia má položka v `specs` (napr. RAM pre IT, veľkosť pre šport).

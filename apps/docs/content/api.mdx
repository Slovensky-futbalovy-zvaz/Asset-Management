...
Pre dev kontext si pozrite [Roadmap](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/ROADMAP.md).
...
- [Backend source code](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/tree/main/apps/api)
- [Zod schemas](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/tree/main/packages/shared-types)

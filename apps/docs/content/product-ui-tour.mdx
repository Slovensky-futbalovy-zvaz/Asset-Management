...
Tento dokument vás prevedie **6 hlavnými obrazovkami** aplikácie Inventario. Pre **interaktívne demo** (kde môžete kliknúť, prepínať tenanty a viewporty) navštívte [inventario.sportup.sk/interactive-demo](https://inventario.sportup.sk/interactive-demo).
...
➡️ **[inventario.sportup.sk/interactive-demo](https://inventario.sportup.sk/interactive-demo)**
...
- **Mockup zdrojový kód**: [docs/design/screens/](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/tree/main/docs/design/screens) — všetky 6 obrazoviek ako self-contained HTML
- **Marketing wrapper**: [docs/marketing-site/interactive-demo.html](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/docs/marketing-site/interactive-demo.html) — verejne nasadený demo na inventario.sportup.sk

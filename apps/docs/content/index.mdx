...
Tieto stránky obsahujú **technickú dokumentáciu** projektu — pre používateľský pohľad navštívte [inventario.sportup.sk](https://inventario.sportup.sk).
...
- **Open source** pod [EUPL-1.2](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/LICENSE) — oficiálne odporúčaná licencia Európskej komisie
...
Inventario je **open-source projekt**. Pull requesty sú vítané. Pozrite si [CONTRIBUTING.md](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/CONTRIBUTING.md).

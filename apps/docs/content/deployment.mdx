...
Pozrite si [inventario.sportup.sk/pricing](https://inventario.sportup.sk/pricing).
...
Od **4 990 € / rok** podľa veľkosti (počet používateľov, dátový objem). Detaily na [pricing stránke](https://inventario.sportup.sk/pricing).
...
Detaily v [BRAND.md](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/BRAND.md).
...
- **Self-hosted fork**: voliteľné consulting (100 €/hod), alebo komunita cez [GitHub Discussions](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/discussions)

## Ďalšie zdroje

- [infra/vercel/DEPLOYMENT.md](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/infra/vercel/DEPLOYMENT.md) — Vercel-specific guide
- [infra/vercel/DNS-SETUP.md](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/infra/vercel/DNS-SETUP.md) — DNS provider guides
- [BRAND.md](https://github.com/Slovensky-futbalovy-zvaz/Asset-Management/blob/main/BRAND.md) — Brand identity + whitelabel pravidlá
